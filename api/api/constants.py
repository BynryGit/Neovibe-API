...
CONSUMER_CARE_DASHBOARD = get_sub_module_by_key('CONSUMER_CARE_DASHBOARD') if get_sub_module_by_key('CONSUMER_CARE_DASHBOARD') else ''
CONSUMER_OPS_DASHBOARD = get_sub_module_by_key('CONSUMER_OPS_DASHBOARD') if get_sub_module_by_key('CONSUMER_OPS_DASHBOARD') else ''
GAS_MANAGEMENT_DASHBOARD = get_sub_module_by_key('GAS_MANAGEMENT_DASHBOARD') if get_sub_module_by_key('GAS_MANAGEMENT_DASHBOARD') else ''
WORK_ORDER_DASHBOARD = get_sub_module_by_key('WORK_ORDER_DASHBOARD') if get_sub_module_by_key('WORK_ORDER_DASHBOARD') else ''
...
HUMAN_CAPITAL_DASHBOARD = get_sub_module_by_key('HUMAN_CAPITAL_DASHBOARD') if get_sub_module_by_key('HUMAN_CAPITAL_DASHBOARD') else ''
...
S_AND_M_REGISTRATION = get_sub_module_by_key('S_AND_M_REGISTRATION') if get_sub_module_by_key('S_AND_M_REGISTRATION') else ''
CONSUMER_CARE_REGISTRATION = get_sub_module_by_key('CONSUMER_CARE_REGISTRATION') if get_sub_module_by_key('CONSUMER_CARE_REGISTRATION') else ''
CONSUMER_OPS_REGISTRATION = get_sub_module_by_key('CONSUMER_OPS_REGISTRATION') if get_sub_module_by_key('CONSUMER_OPS_REGISTRATION') else ''
REPORTS = get_sub_module_by_key('Reports') if get_sub_module_by_key('Reports') else ''
...
SURVEY = get_sub_module_by_key('S&M-Survey') if get_sub_module_by_key('S&M-Survey') else ''
...
S_AND_M_USER = get_sub_module_by_key('S_AND_M_USER') if get_sub_module_by_key('BILLING') else ''
...
GAS_MANAGEMENT_USER = get_sub_module_by_key('GAS_MANAGEMENT_USER') if get_sub_module_by_key('GAS_MANAGEMENT_USER') else ''
