...
# API Header
# API end Point: api/v1/asset/id_string/notes
# API verb: GET, POST
# Package: Basic
# Modules: asset
# Sub Module: Notes
# Interaction: for get and add asset notes
# Usage: API will fetch and add all notes under asset.
...
# API Header
# API end Point: api/v1/asset/note/id_string
# API verb: GET, PUT
# Package: Basic
# Modules: asset
# Sub Module: Notes
# Interaction: for get and edit asset note
# Usage: API will fetch and edit note under asset.
# Tables used: 2.5.12 Notes
# Author: Priyanka
