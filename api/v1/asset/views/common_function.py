...
from v1.asset.models.asset_category import get_asset_category_by_id_string
from v1.asset.models.asset_sub_category import get_asset_sub_category_by_id_string
...
def set_asset_validated_data(validated_data):
    ...
    if "category_id" in validated_data:
        consumer_category = get_asset_category_by_id_string(validated_data["category_id"])
        validated_data["category_id"] = consumer_category.id

    if "sub_category_id" in validated_data:
        sub_category = get_asset_sub_category_by_id_string(validated_data["sub_category_id"])
