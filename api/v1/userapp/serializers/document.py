...
from v1.commonapp.serializers.document_sub_module import DocumentSubTypeSerializer
...
class DocumentListSerializer(serializers.ModelSerializer):
    ...
    identification = UserSerializer(many=False, required=True, source='get_identification')

    class Meta:
        model = Document
        fields = ('id_string', 'tenant', 'utility', 'module', 'sub_module', 'document_type.py', 'document_sub_type',
