...
from v1.meter_reading.serializers.route_assignment_status import RouteAssignmentStatusShortViewSerializer
...
class JobcardViewSerializer(serializers.ModelSerializer):
    ...
    route_assigned_id = RouteAssignmentStatusShortViewSerializer(many=False, required=False,
    ...
    class Meta:
        model = JobcardTbl
        fields = ('id_string', 'consumer_no', 'month', 'assign_date', 'completion_date', 'bill_cycle_id', 'route_id',
                  'route_assigned_id', 'meter_reader_id', 'tenant', 'utility')