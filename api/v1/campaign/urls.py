...
from v1.campaign.views.campaign_status import CampaignList,CampaignStatusView
...
urlpatterns = [
    ...
    path('group/<uuid:id_string>/', CampaignGroupView.as_view(),name="campaign_gropu"),
    path('objective/list', CampaignObjectiveList.as_view(),name="campaign_objective_list"),
    path('objective/<uuid:id_string>/', CampaignObjectiveView.as_view(),name="campaign_gropu"),
    path('campaign-status/list/', CampaignList.as_view(), name="campaign_status_list"),
