...
# API Header
# API end Point: api/v1/campaign/id_string/documents
# API verb: GET, POST
# Package: Basic
# Modules: Camapign
# Sub Module: Document
...
# API Header
# API end Point: api/v1/campaign/document/id_string
# API verb: GET, PUT
# Package: Basic
# Modules: campaign
# Sub Module: Document
# Interaction: for get and edit campaign document
# Usage: API will fetch and edit documents under campaign.
# Tables used: 2.12.13 Document
# Author: Priyanka
