...
from v1.campaign.serializers.notes import NoteSerializer


# API Header
# API end Point: api/v1/campaign/id_string/notes
# API verb: GET, POST
# Package: Basic
# Modules: campaign
# Sub Module: Notes
# Interaction: for get and add campaign notes
# Usage: API will fetch and add all notes under campaign.
...
# API Header
# API end Point: api/v1/campaign/note/id_string
# API verb: GET, PUT
# Package: Basic
# Modules: campaign
# Sub Module: Notes
# Interaction: for get and edit campaign note
# Usage: API will fetch and edit note under campaign.
# Tables used: 2.5.12 Notes
# Author: Priyanka
# Created on: 15/05/2020
