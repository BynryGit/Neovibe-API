...
from v1.work_order.models.material_type import MaterialType as MaterialTypeModel
...
# API Header
# API end Point: api/v1/work_order/:id_string/material_type/list
# API verb: GET
# Package: Basic
# Modules: Admin
# Sub Module: Admin
# Interaction: Rule list
# Usage: API will fetch all Material Type list
# Tables used: MaterialType
# Author: Chinmay
# Created on: 22/12/2020

class MaterialTypeList(generics.ListAPIView):
    try:
        ...
        def get_queryset(self):
            ...
            if response:
                if is_authorized(1, 1, 1, user_obj):
                    ...
                    queryset = MaterialTypeModel.objects.filter(utility=utility, is_active=True)
                    if queryset:
                        return queryset
                    else:
                        raise CustomAPIException("Material Type not found.", status.HTTP_404_NOT_FOUND)
                else:
