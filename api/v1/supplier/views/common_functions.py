...
def set_supplier_service_validated_data(validated_data):
    # Todo for tupe,status and source type, category, subcategory
    # if "service_category" in validated_data:
    #     service_category = get_supplier_product_category_by_id_string(validated_data["service_category"])
    #     validated_data["service_category"] = service_category.id
    # if "service_subcategory" in validated_data:
    #     service_subcategory = get_supplier_product_subcategory_by_id_string(validated_data["service_subcategory"])
