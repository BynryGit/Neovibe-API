        ...
        def get_queryset(self):
            if is_token_valid(self.request.headers['token']):
                if is_authorized():
                    ...
                    if supplier_obj:
                        queryset = ContractTbl.objects.filter(supplier=supplier_obj.id, is_active=True)
                        return queryset
                    else:
                ...
                # Checking authorization end
                    ...
                    if supplier_obj:
                        ...
                        if serializer.is_valid():
                            supplier_contract_obj = serializer.create(serializer.validated_data, supplier_obj, user)
