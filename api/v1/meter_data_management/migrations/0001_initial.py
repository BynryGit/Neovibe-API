    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('spot_bill_detail', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('rate_detail', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('utility_product_id', models.BigIntegerField(blank=True, null=True)),
                ('state', models.IntegerField(choices=[(0, 'CREATED'), (1, 'NO-DATA'), (2, 'IN-PROGRESS'), (3, 'PARTIAL'), (4, 'COMPLETED'), (5, 'ARCHIVED')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('state', models.IntegerField(choices=[(0, 'NOT-DISPATCHED'), (1, 'IN-PROGRESS'), (2, 'STARTED'), (3, 'DISPATCHED'), (4, 'PARTIAL'), (5, 'ASSIGN-FAIL'), (6, 'DE-ASSIGN-FAIL'), (7, 'COMPLETED'), (8, 'ARCHIVED')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meter_status_v1_id', models.BigIntegerField(blank=True, null=True)),
                ('meter_status_v2_id', models.BigIntegerField(blank=True, null=True)),
                ('reader_status_id', models.BigIntegerField(blank=True, null=True)),
                ('reader_status_v1_id', models.BigIntegerField(blank=True, null=True)),
                ('reader_status_v2_id', models.BigIntegerField(blank=True, null=True)),
                ...
                ('spot_bill_json', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumer_no', models.CharField(blank=True, max_length=200, null=True)),
                ('meter_no', models.CharField(blank=True, max_length=200, null=True)),
                ('state', models.IntegerField(choices=[(0, 'MANUAL'), (1, 'SMART')], default=0)),
                ('is_spot_bill', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=True)),
                ('created_by', models.BigIntegerField(blank=True, null=True)),
                ('updated_by', models.BigIntegerField(blank=True, null=True)),
