    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('consumer_meter_json', django.contrib.postgres.fields.jsonb.JSONField(default=[])),
                ('dispatch_status', models.IntegerField(choices=[(0, 'NOT-DISPATCHED'), (1, 'IN-PROGRESS'), (2, 'STARTED'), (3, 'DISPATCHED'), (4, 'PARTIAL'), (5, 'ASSIGN-FAIL'), (6, 'DE-ASSIGN-FAIL')], default=0)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('meter_reading_json', django.contrib.postgres.fields.jsonb.JSONField(default=[])),
