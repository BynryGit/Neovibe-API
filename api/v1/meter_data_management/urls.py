...
from v1.meter_data_management.views.bill_cycle import BillCycleList, BillCycleDetail
from v1.meter_data_management.views.consumer import consumerList, consumerDetail
from v1.meter_data_management.views.job_card import JobcardList
from v1.meter_data_management.views.route_assignment import RouteAssignment, RouteAssignmentDetail
from v1.meter_data_management.views.meter_reader import MeterReaderList, MeterReaderDetail
from v1.meter_data_management.views.meter_reading import MeterReading, MeterReadingList, MeterReadingDetail
from v1.meter_data_management.views.route import RouteList, RouteDetail
from v1.meter_data_management.views.route_upload import RouteUpload
from v1.meter_data_management.views.schedule import Schedule, ScheduleList, ScheduleDetail
from v1.meter_data_management.views.validation import ValidationList, ValidationDetail
