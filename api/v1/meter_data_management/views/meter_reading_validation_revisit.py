...
from v1.meter_data_management.serializers.meter_reading_validation_revisit import MeterReadingValidationRevisitSerializer


# API Header
# API end Point: api/v1/meter-data/validation-revisit
# API verb: POST
# Package: Basic
# Modules: All
# Sub Module: All
...
class MeterReadingValidationRevisitDetail(GenericAPIView):
    @is_token_validate
    ...
    def put(self, request, id_string):
        try:
            ...
            if meter_reading_obj:
                meter_reading_serializer = MeterReadingValidationRevisitSerializer(data=request.data)
