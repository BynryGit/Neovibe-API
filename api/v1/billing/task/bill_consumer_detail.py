...
def create_bill_consumers(schedule_log_id):
    try:
        ...
        print('*****schedule_log_obj*********',schedule_log_obj)
        read_cycle_obj = get_bill_cycle_by_id(schedule_log_obj.bill_cycle_id)
