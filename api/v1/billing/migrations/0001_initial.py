    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('template', models.TextField(blank=True, max_length=20000, null=True)),
                ('is_active', models.BooleanField(default=True)),
                ('created_by', models.BigIntegerField(blank=True, null=True)),
                ('updated_by', models.BigIntegerField(blank=True, null=True)),
                ('created_date', models.DateTimeField(blank=True, default=django.utils.timezone.now, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('id_string', models.UUIDField(default=uuid.uuid4, editable=False, unique=True)),
                ('utility_product_id', models.BigIntegerField(blank=True, null=True)),
                ('meter_no', models.BigIntegerField(blank=True, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bill_cycle_id', models.BigIntegerField(blank=True, null=True)),
                ('consumer_no', models.CharField(blank=True, max_length=200, null=True)),
                ('state', models.BigIntegerField(choices=[(0, 'CREATED'), (1, 'UN BILLED'), (2, 'IN PROGRESS'), (3, 'PARTIAL'), (4, 'HOLD'), (5, 'COMPLETED'), (6, 'APPROVED'), (7, 'ARCHIVED')], default=0)),
                ...
                ('bill_period', models.CharField(max_length=200)),
                ('meter_reading', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('rate_details', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ('additional_charges', django.contrib.postgres.fields.jsonb.JSONField(blank=True, null=True)),
                ...
                ('invoice_template', models.TextField(blank=True, max_length=20000, null=True)),
                ('is_verified', models.BooleanField(default=False)),
                ('is_adjusted', models.BooleanField(default=False)),
                ('is_spot_bill', models.BooleanField(default=False)),
                ('is_active', models.BooleanField(default=False)),
