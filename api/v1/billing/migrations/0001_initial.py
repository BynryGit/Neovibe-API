    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('bill_period', models.CharField(max_length=200)),
                ('meter_reading', django.contrib.postgres.fields.jsonb.JSONField()),
                ('rate_details', django.contrib.postgres.fields.jsonb.JSONField()),
                ('additional_charges', django.contrib.postgres.fields.jsonb.JSONField()),
