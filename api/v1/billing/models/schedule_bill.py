...
class ScheduleBill(models.Model):
    ...
    schedule_date = models.DateTimeField(null=True, blank=True, default=datetime.now())
    billing_date = models.DateTimeField(null=True, blank=True, default=datetime.now())
