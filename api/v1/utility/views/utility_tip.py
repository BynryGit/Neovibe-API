...
# Author: Rohan
# Created on: 6/1/2021
class UtilityTipList(generics.ListAPIView):
    try:
        serializer_class = UtilityTipListSerializer
            ...
            if response:
                if is_authorized(1, 1, 1, user_obj):
                    ...
                    if queryset:
                        ...
                        raise CustomAPIException("Tip details Not found.", status.HTTP_404_NOT_FOUND)
                else:
