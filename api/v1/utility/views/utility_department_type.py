...
from v1.utility.serializers.utility_department_type import UtilityDepartmentTypeListSerializer
from v1.utility.models.utility_department_type import UtilityDepartmentType as UtilityDepartmentTypeModel
...
# API Header
# API end Point: api/v1/:id_string/dept_type/list
# API verb: GET
# Package: Basic
# Modules: Admin
# Sub Module: Admin
...
class UtilityDepartmentTypeList(generics.ListAPIView):
    try:
        serializer_class = UtilityDepartmentTypeListSerializer
        ...
        def get_queryset(self):
            ...
            if response:
                if is_authorized(1, 1, 1, user_obj):
                    ...
                    queryset = UtilityDepartmentTypeModel.objects.filter(utility=utility, is_active=True)
                    if queryset:
                        return queryset
                    else:
