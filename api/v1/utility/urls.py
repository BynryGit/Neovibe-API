...
urlpatterns = [
    ...
    path('<uuid:id_string>/modules', UtilityModuleList.as_view(), name='utility_module_list'),
    path('module/<uuid:id_string>', UtilityModuleDetail.as_view(), name='utility_module_details'),
    path('<uuid:id_string>/submodules', UtilitySubModuleList.as_view(), name='utility_submodule_list'),
