...
class ClosureReportTransaction(models.Model):
    ...
    closure_report_id = models.BigIntegerField(null=True, blank=True)
    sop_master_id = models.BigIntegerField(null=True, blank=True)
    sop_master_detail_id = models.BigIntegerField(null=True, blank=True)
    ...
    sop_status_id = models.BigIntegerField(null=True, blank=True)
