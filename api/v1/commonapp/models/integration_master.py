...
class IntegrationMaster(models.Model):
    ...
    auth_key = models.CharField(max_length=200, blank=True, null=True)
    development_url = models.CharField(max_length=1000, blank=True, null=True)
    testing_url = models.CharField(max_length=1000, blank=True, null=True)
