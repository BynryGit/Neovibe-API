...
class TransitionConfiguration(models.Model):
    ...
    transition_object = models.BigIntegerField(max_length=30, choices=CHOICES, default=0)
    transition_state = models.BigIntegerField(max_length=200, null=True, blank=True)
    channel = models.BigIntegerField(max_length=30, choices=CHANNEL_CHOICES, default=0)
