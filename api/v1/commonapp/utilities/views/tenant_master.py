...
class TenantMasterUpload(GenericAPIView):
    @is_token_validate
    ...
    def post(self, request):
        try:
            with transaction.atomic():
                ...
                tenant_master_values = []
                loc = (r"/home/ubuntu/smart360/api/v1/commonapp/utilities/xls_files/Tenant Master Final.xls")
                ...
                for row in range(1, number_of_rows):
                    ...
                    tenant_master_values.append(row_values)

                for value in tenant_master_values:
                    if TenantMasterTbl.objects.filter(name=value[1], is_active=True).exists():
                        pass
                    else:
                        TenantMasterTbl(
                            short_name=value[0],
