...
class RoleSubTypeUpload(GenericAPIView):
    @is_token_validate
    ...
    def post(self, request, id_string):
        try:
            with transaction.atomic():
                ...
                role_sub_type_values = []
                loc = (r"/home/ubuntu/smart360/api/v1/commonapp/utilities/xls_files/Role Sub Type Final.xls")
                ...
                for row in range(1, number_of_rows):
                    ...
                    role_sub_type_values.append(row_values)

                for value in role_sub_type_values:
                    if RoleSubTypeTbl.objects.filter(tenant=tenant_obj,name=value[2], is_active=True).exists():
                        pass
                    else:
                        RoleSubTypeTbl(
                            tenant=tenant_obj,
