...
class TenantModuleUpload(GenericAPIView):
    @is_token_validate
    ...
    def post(self, request, id_string):
        try:
            with transaction.atomic():
                ...
                loc = (r"/home/ubuntu/smart360/api/v1/commonapp/utilities/xls_files/Tenant Module Final.xls")
                ...
                for row in range(1, number_of_rows):
                    ...
                    tenant_module_values.append(row_values)

                for value in tenant_module_values:
                    if TenantModuleTbl.objects.filter(tenant=tenant_obj,module_id=value[1], is_active=True).exists():
                        pass
                    else:
                        TenantModuleTbl(
                            tenant=tenant_obj,
