...
class UserRoleUpload(GenericAPIView):
    @is_token_validate
    ...
    def post(self, request, id_string):
        try:
            with transaction.atomic():
                ...
                user_role_values = []
                loc = (r"/home/ubuntu/smart360/api/v1/commonapp/utilities/xls_files/User-Role-Final.xls")
                ...
                for row in range(1, number_of_rows):
                    ...
                    user_role_values.append(row_values)

                for value in user_role_values:
                    if UserRoleTbl.objects.filter(tenant=tenant_obj,role_id=value[1],user_id=value[2], is_active=True).exists():
                        pass
                    else:
                        UserRoleTbl(
                            tenant=tenant_obj,
