...
class RoleUpload(GenericAPIView):
    @is_token_validate
    ...
    def post(self, request, id_string):
        try:
            with transaction.atomic():
                ...
                role_values = []
                loc = (r"/home/ubuntu/smart360/api/v1/commonapp/utilities/xls_files/Role-Final.xls")
                ...
                for row in range(1, number_of_rows):
                    ...
                    role_values.append(row_values)

                for value in role_values:
                    if RoleTbl.objects.filter(tenant=tenant_obj,type_id=value[1],sub_type_id=value[2], is_active=True).exists():
                        pass
                    else:
                        RoleTbl(
                            tenant=tenant_obj,
