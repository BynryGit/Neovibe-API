...
class MaterialTypeUpload(GenericAPIView):
    @is_token_validate
    ...
    def post(self, request, id_string):
        try:
            with transaction.atomic():
                ...
                loc = (r"/home/ubuntu/smart360/api/v1/commonapp/utilities/xls_files/Material-Type-Final.xls")
                ...
                for row in range(1, number_of_rows):
                    ...
                    material_type_values.append(row_values)

                for value in material_type_values:
                    if MaterialTypeTbl.objects.filter(tenant=tenant_obj,name=value[1],is_active=True).exists():
                        pass
                    else:
                        MaterialTypeTbl(
                            tenant=tenant_obj,
