...
from v1.work_order.models.work_order_rules import WorkOrderRule as WorkOrderRulesTbl
...
class WorkOrderRulesUpload(GenericAPIView):
    @is_token_validate
    ...
    def post(self, request, id_string):
        try:
            with transaction.atomic():
                ...
                work_order_rules_values = []
                loc = (r"/home/ubuntu/smart360/api/v1/commonapp/utilities/xls_files/Work-Order-Rule.xls")
                ...
                for row in range(1, number_of_rows):
                    ...
                    work_order_rules_values.append(row_values)

                for value in work_order_rules_values:
                    if WorkOrderRulesTbl.objects.filter(tenant=tenant_obj,rule_id=value[1],rule=value[2],is_active=True).exists():
                        pass
                    else:
                        WorkOrderRulesTbl(
                            tenant=tenant_obj,
