...
from v1.consumer.models.service_sub_type import ServiceSubType as ServiceSubTypeModel,get_service_sub_type_by_id_string
from v1.consumer.serializers.service_sub_type import ServiceSubTypeListSerializer,ServiceSubTypeViewSerializer,ServiceSubTypeSerializer
...
# API Header
# API end Point: api/v1/Complaint/utility/:id_string/service_subtype/list
# API verb: GET
# Package: Basic
# Modules: Admin
# Sub Module: Admin
            ...
            if response:
                if is_authorized(1, 1, 1, user_obj):
                    ...
                    if queryset:
                        ...
                        raise CustomAPIException("Service Subtype Type not found.", status.HTTP_404_NOT_FOUND)
                else:
...
# API Header
# API end Point: api/v1/service/service_subtype
# API verb: POST
# Package: Basic
# Modules: Admin
# Sub Module: Admin
...
# API Header
# API end Point: api/v1/service/service_subtype/:id_string
# API verb: GET,PUT
# Package: Basic
# Modules: Admin
# Sub Module: Admin
