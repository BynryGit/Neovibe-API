...
# API Header
# API end Point: api/v1/Complaint/service_type/:id_string
# API verb: GET,PUT
# Package: Basic
# Modules: Admin
# Sub Module: Admin
# Interaction: Service Type corresponding to the id
# Usage: API will fetch and update Service Types for a given id
# Tables used: Service Types
# Author: Chinmay
# Created on: 28/11/2020
