...
from v1.tenant.views.tenant_invoice_payment import TenantInvoicePaymentList, TenantInvoicePayment, TenantInvoicePaymentDetail
...
urlpatterns = [
    ...
    path('subscription-plan-rate/list', TenantSubscriptionPlanRateList.as_view(), name='tenant_subscription_plan_rate_list'),
