...
# API Header
# API end Point: api/v1/location-survey/list
# API verb: GET
# Package: Basic
# Modules: S&M
# Sub Module: Survey
# Interaction: Location-Survey list
# Usage: API will fetch required data for Location Survey list
...
class LocationSurveyListApiView(APIView):
...
# API Header
# API end Point: api/v1/consumer-survey/list
# API verb: GET
# Package: Basic
# Modules: S&M
# Sub Module: Survey
# Interaction: Consumer-Survey list
# Usage: API will fetch required data for Consumer Survey list
# Tables used: 2.3.1 Survey Master,2.3.4 Survey Consumer
# Author: Priyanka
# Created on: 29/04/2020


# API for getting list data of Consumer Survey
class ConsumerSurveyListApiView(APIView):
